...
const u8 gText_PokeSum_Controls_Page[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}EV/IV");
...
const u8 gText_TypeEffModeOrig [] = _("ORIGINAL");
const u8 gText_TypeEffModeAdvanced [] = _("ADVANCED");
