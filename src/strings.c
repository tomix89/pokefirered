...
const u8 gText_ExpGainSpeed[] = _("EXP. GAIN SPEED");
const u8 gText_TypeEffMode [] = _("TYPE EFF. MODE");
...
const u8 gText_ExpGainSpeedNormal[] = _("NORMAL (1x)");
const u8 gText_ExpGainSpeedMedium[] = _("MEDI (1.2x)");
const u8 gText_ExpGainSpeedFast[] = _("FAST (1.5x)");
const u8 gText_ExpGainSpeedUltra[] = _("ULTRA (2x)");
const u8 gText_TypeEffModeBase [] = _("BASIC");
const u8 gText_TypeEffModeSimple [] = _("SIMPLE");
const u8 gText_TypeEffModeFull [] = _("FULL");
