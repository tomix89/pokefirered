...
extern const u8 gText_MoveInterfaceDynamicColorsEff[];
extern const u8 gText_MoveInterfaceTypeImmune[];
extern const u8 gText_MoveInterfaceTypeStatMove[];
...
extern const u8 gText_ExpGainSpeedNormal[];
