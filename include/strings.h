...
extern const u8 gText_MoveInterfaceEff[];
extern const u8 gText_MoveInterfaceEffDualBattle[];
extern const u8 gText_MoveInterfaceEffDynamicColors[];
extern const u8 gText_MoveInterfaceEffImmune[];
extern const u8 gText_MoveInterfaceEffStatMove[];
...
extern const u8 gText_ExpGainModifier[];
extern const u8 gText_ExpShareRatio[];
...
extern const u8 gText_TypeEffModeOrig[];
extern const u8 gText_TypeEffModeAdvanced[];
